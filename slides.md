...
- たじまんです (tajiman, schktjm)
- SmartHRのアクセシビリティ横断チームで、アクセシビリティエンジニアをしています
- 2024年8月入社して1年半
- 前職はフロントエンドエンジニア
...
<figure class="!my-0">
  ...
  <figcaption class="!text-center">たじまんのインターネット上のすがた</figcaption>
</figure>
...
- 昨今のエンジニアには、AI技術のキャッチアップを初め、セキュリティ要件やパフォーマンス改善などアクセシビリティよりも優先タスクがあると捉えられている -->
...
- プロダクトエンジニア目線は、プロダクトの品質をあげるハードルがさがるきっかけができてハッピー
- アクセシビリティ部が半ば強引に「きっかけ」を提供することで、一歩進みやすくする

<p v-click>大臣がいないチームやメンテナンス状態で専任の開発チームがいないプロダクトにはまだ課題が多いため、まだ仕事はなくならない</p>
...
- エンジニアがアクセシビリティ改善チケットを後回しにするのは、やりたくないや関心がないのではなく、今はできないハードルが原因なのかもしれない
- 明日できること
...
[@schktjm](https://x.com/schktjm) <br>
[株式会社SmartHR 採用サイト](https://recruit.smarthr.co.jp/)